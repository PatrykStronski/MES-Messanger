...
function registerUser(user, cred) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.query("INSERT INTO account(login,pass,name,lname) VALUES('" + cred.login + "','" + cred.password + "','" + user.name + "','" + user.lname + "');")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function createToken(creds) {
    var mykey = crypto.createCipheriv('aes-128-cbc', creds.password, "iv");
    var mystr = mykey.update(creds.login, 'utf8', 'hex');
    return mystr;
}
